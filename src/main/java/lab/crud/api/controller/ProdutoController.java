...
public class ProdutoController {
	...
	//curl -X POST http://localhost:8080/produtos -H "Content-Type: application/json; Charset=utf-8" -d @produto-pizza-calabresa.json

	}
 
		

	//curl -X PUT http://localhost:8081/produtos/1 -H "Content-Type: application/json; Charset=utf-8" -d @produto-pao-doce.json
